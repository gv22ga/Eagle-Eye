...
import neutrinos.eagleeyeserver.activities.FoundDetailActivity;
import neutrinos.eagleeyeserver.activities.MapsActivity;
...
public class FoundAdapter extends RecyclerView.Adapter<FoundAdapter.ViewHolder>  {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View v){
            ...
            card_found = (LinearLayout)v.findViewById(R.id.card_found);
            iv_image = (ImageView)v.findViewById(R.id.iv_image);
            mView=v;
        }
    }

    public FoundAdapter(Context context, ArrayList<String> missing_id, ArrayList<String> missing_name, ArrayList<String> missing_age, ArrayList<String> missing_sex,
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_found_person, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.card_found.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(context, FoundDetailActivity.class);
                i.putExtra("id",mmissing_id.get(position));
