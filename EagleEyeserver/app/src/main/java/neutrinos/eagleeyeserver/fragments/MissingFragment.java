...
public class MissingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_missing, container, false);
        mRecyclerView=(RecyclerView)rootView.findViewById(R.id.recycler_missing_list);
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                progress.dismiss();
                    ...
                    if (missing_list.size() > 0) {
                        ...
                        mAdapter = new MissingAdapter(getActivity(), missing_id,missing_name,missing_age,missing_sex,missing_address,missing_latitude,missing_longitude,missing_range,missing_reporter_contact,missing_image,missing_status);

                        mRecyclerView.setAdapter(mAdapter);

                    } else {
                        Toast.makeText(getActivity(), "No missing Persons :)", Toast.LENGTH_SHORT).show();
                    }
                }
        };
